...
public class WordBreak {
    ...
    public boolean wordBreak(String s, Set<String> dict) {
        ...
        for (int i = 0; i < starts.size(); i++) {
            for(int j = 0; j < ends.size(); j++) {
                ...
                if(isThereAValidPath(starts.get(i), ends.get(j), intervals))
                    return true;
    ...
    private boolean isThereAValidPath (Interval start, Interval end, ArrayList<Interval> intervals) {
        ...
        for (int i = 0; i < intervals.size(); i++) {
            ...
            if(start.end+1 == cur.start)
                if(isThereAValidPath(cur, end, intervals))
                    return true;
        }
